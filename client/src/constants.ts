...
export const themes: ThemesType = {
  locker: {
    ...
    selectionLimits: {
      "Locker Base": { min: 1, max: Infinity },
      "Top Shelf": { min: 0, max: Infinity },
      "Bottom Shelf": { min: 0, max: Infinity },
      "Door": { min: 0, max: Infinity },
    },
    defaultOpenCategories: {
      "Locker Base": true,
      "Wallpaper": false,
  ...
  desk: {
    ...
    selectionLimits: {
      "Desk Base": { min: 1, max: 1 },
      "Ambiance Textures": { min: 0, max: Infinity },
      "Accessories": { min: 0, max: Infinity },
      "Computer": { min: 0, max: Infinity },
      "Chair": { min: 0, max: Infinity },
    },
    defaultOpenCategories: {
      "Desk Base": true,
